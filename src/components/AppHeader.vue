    ...
    <div class="sticky top-0 z-40">
        <div class="w-full h-20 px-6 bg-gray-100 border-b flex items-center justify-between">
            ...
            <div class="flex items-center relative">
                ...
                <img src="https://a7sas.net/wp-content/uploads/2019/07/4060.jpeg" class=" cursor-pointer w-12 h-12 rounded-full shadow-lg" @click="dropDownOpen = !dropDownOpen">
            </div>
...
export default {
    name: 'Navbar',
    computed: {
        ...mapGetters({ sideBarOpen: "sidebar/sideBarOpen" })
    },
    data() {
        return {
            dropDownOpen: false
